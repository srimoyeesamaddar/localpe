...
C       do inhh = 0,0
       ...
       write(outfile1,'("IRI_0004_2013-",i2.2,"Z_NmF2_",a2,".dat")')
     & ievent,isr(ist)
        write(outfile2,'("IRI_0004_2013-",i2.2,"Z_foF2_",a2,".dat")')
     & ievent,isr(ist)
        write(outfile3,'("IRI_0004_2013-",i2.2,"Z_hmF2_",a2,".dat")')
     & ievent,isr(ist)
        write(outfile4,'("IRI_0004_2013-",i2.2,"Z_TEC_",a2,".dat")')
     & ievent,isr(ist)
...
C        enddo !ilon
C        enddo !ilat 
       if(im.eq.3.and.id.eq.1.and.inhh.eq.0.and.inmm.eq.0) then
       write(20,'("# IRI 2016")')
