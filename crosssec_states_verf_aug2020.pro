...
xr=[0.1,20.]
 ...
 O_crss1=plot(NRL_wv,O_prob_state_nrl[1,*]*sigionx_nrl(0,*),name=O_nam[0],$
   xtitle=xt,ytitle=yt,title=maj[0]+titl,$
   xstyle=1,ystyle=1,xrange=xr,xlog=0,ylog=1,$;yrange=yr,
 ...
 O_crss2=plot(NRL_wv,O_prob_state_nrl[2,*]*sigionx_nrl(0,*),name=O_nam[1],$
   thick=thck,color=colors[1],symbol=sym[2],sym_thick=sym_thck,/overplot)

O_crss3=plot(NRL_wv,O_prob_state_nrl[3,*]*sigionx_nrl(0,*),name=O_nam[2],$
   thick=thck,color=colors[2],symbol=sym[2],sym_thick=sym_thck,/overplot)

 O_crss4=plot(SQ_wv,O_prob_state_SQ[1,*]*sigionx_SQ(0,*),name=O_nam[3],$
   thick=thck,color=colors[0],symbol=sym[1],sym_thick=sym_thck,/overplot)

 O_crss5=plot(SQ_wv,O_prob_state_SQ[2,*]*sigionx_SQ(0,*),name=O_nam[4],$
   thick=thck,color=colors[1],symbol=sym[1],sym_thick=sym_thck,/overplot)

 O_crss6=plot(SQ_wv,O_prob_state_SQ[3,*]*sigionx_SQ(0,*),name=O_nam[5],$
...
;  yr=[0.,1.5e-18]
 ...
 O2_crss1=plot(NRL_wv,O2_prob_state_NRL[1,*]*sigionx_nrl(1,*),name=O2_nam[0],$
   xtitle=xt,ytitle=yt,title=maj[1]+titl,$
   xstyle=1,ystyle=1,xrange=xr,xlog=0,ylog=1,$;
   xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
   thick=thck,color=colors[0],symbol=sym[2],sym_thick=sym_thck,font_size=fnt_sz,/current)

 O2_crss2=plot(NRL_wv,O2_prob_state_NRL[2,*]*sigionx_nrl(1,*),name=O2_nam[1],$
   thick=thck,color=colors[1],symbol=sym[2],sym_thick=sym_thck,/overplot)

 O2_crss3=plot(SQ_wv,O2_prob_state_SQ[1,*]*sigionx_SQ(1,*),name=O2_nam[2],$
   thick=thck,color=colors[0],symbol=sym[1],sym_thick=sym_thck,/overplot)

 O2_crss4=plot(SQ_wv,O2_prob_state_SQ[2,*]*sigionx_SQ(1,*),name=O2_nam[3],$
   thick=thck,color=colors[1],symbol=sym[1],sym_thick=sym_thck,/overplot)

 O2_crss5=plot(nrL_wv,  total(O2_prob_state_NRLALL[1:3,*],1)*sigionx_nrl(1,*),name=O2_nam[4],$
   thick=thck,color=colors[0],symbol=sym[0],sym_thick=sym_thck,/overplot)

 O2_crss6=plot(NRL_wv,total(O2_prob_state_NRLALL[4:-1,*],1)*sigionx_nrl(1,*),name=O2_nam[5],$
...
;xr=[0.1,20.]
 ...
 N2_crss1=plot(NRL_wv,N2_prob_state_NRL[1,*]*sigionx_nrl(2,*),name=N2_nam[0],$
   xtitle=xt,ytitle=yt,title=maj[2]+titl,$
   xstyle=1,ystyle=1,xrange=xr,xlog=0,ylog=1,$;
   xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
   thick=thck,color=colors[0],symbol=sym[2],sym_thick=sym_thck,font_size=fnt_sz,/current)

 N2_crss2=plot(NRL_wv,N2_prob_state_NRL[2,*]*sigionx_nrl(2,*),name=N2_nam[1],$
   thick=thck,color=colors[1],symbol=sym[2],sym_thick=sym_thck,/overplot)

 N2_crss3=plot(SQ_wv,N2_prob_state_SQ[1,*]*sigionx_SQ(2,*),name=N2_nam[2],$
   thick=thck,color=colors[0],symbol=sym[1],sym_thick=sym_thck,/overplot)

 N2_crss4=plot(SQ_wv,N2_prob_state_SQ[2,*]*sigionx_SQ(2,*),name=N2_nam[3],$
   thick=thck,color=colors[1],symbol=sym[1],sym_thick=sym_thck,/overplot)

 N2_crss5=plot(nrl_wv,total(N2_prob_state_nrlall[1:3,*],1)*sigionx_nrl(2,*),name=N2_nam[4],$
   thick=thck,color=colors[0],symbol=sym[0],sym_thick=sym_thck,/overplot)

 N2_crss6=plot(nrl_wv,total(N2_prob_state_nrlall[4:-1,*],1)*sigionx_nrl(2,*),name=N2_nam[5],$
   thick=thck,color=colors[1],symbol=sym[0],sym_thick=sym_thck,/overplot)
