...
; Comparing the flare and quiet NRL spectra for O2 and O
...
d1c=plot(O2_NDI_3_X9N,zz,name='O!L2!N!U+!N',$
  thick=thck,color=colors[8],linestyle=lstyl[1],/overplot)
...
q1c=plot(O2_NDI_3_QN,zz,name='O!L2!N!U+!N',$
  thick=2,color=colors[8],linestyle=lstyl[0],/overplot)
...
e1b=plot(N2_r2,zz,name='Pe$\slash$Pi O!L2!N !U+!N ',$
  thick=thck,color=colors[8],linestyle=lstyl[1],/overplot)
...
f1b=plot(N2_r7,zz,name='Pe$\slash$Pi O!L2!N!U+!N',$
  thick=2,color=colors[8],linestyle=lstyl[0],/overplot)
...
d1c=plot(O2_NDI_3_M5N,zz,name='O!L2!N!U+!N',$
  thick=thck,color=colors[8],linestyle=lstyl[1],/overplot)
