...
;ALL plots are w.r.t optical depth
...
N2_pi1=plot(m5_szalo_photoi[sp,*,0],m5_tau[*,0],name=leg_nam1[0],$
...
N2_pi2=plot(m5_szalo_photoi[sp,*,1],m5_tau[*,1],name=leg_nam1[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(m5_szalo_photoi[sp,*,2],m5_tau[*,2],name=leg_nam1[2],$
  thick=thck,color=colors[4],/overplot)

N2_pi4=plot(m5_szalo_photoi[sp,*,3],m5_tau[*,3],name=leg_nam1[3],$
  thick=thck,color=colors[5],/overplot)

N2_pi5=plot(m5_szalo_photoi[sp,*,4],m5_tau[*,4],name=leg_nam1[4],$
  thick=thck,color=colors[6],/overplot)

N2_pi6=plot(m5_szalo_photoi[sp,*,5],m5_tau[*,5],name=leg_nam1[5],$
...
N2_ei1=plot(m5_szalo_eiionz_transp[sp,*,0],m5_tau[*,0],name=leg_nam1[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpmid,/current)

N2_ei2=plot(m5_szalo_eiionz_transp[sp,*,1],m5_tau[*,1],name=leg_nam1[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(m5_szalo_eiionz_transp[sp,*,2],m5_tau[*,2],name=leg_nam1[2],$
  thick=thck,color=colors[4],/overplot)

N2_ei4=plot(m5_szalo_eiionz_transp[sp,*,3],m5_tau[*,3],name=leg_nam1[3],$
  thick=thck,color=colors[5],/overplot)

N2_ei5=plot(m5_szalo_eiionz_transp[sp,*,4],m5_tau[*,4],name=leg_nam1[4],$
  thick=thck,color=colors[6],/overplot)

N2_ei6=plot(m5_szalo_eiionz_transp[sp,*,5],m5_tau[*,5],name=leg_nam1[5],$
  thick=thck,color=colors[7],/overplot)
...
N2_pp1=plot(m5_szalo_eiionz_transp[sp,*,0]/m5_szalo_photoi[sp,*,0],m5_tau[*,0],name=leg_nam1[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpright,/current)

N2_pp2=plot(m5_szalo_eiionz_transp[sp,*,1]/m5_szalo_photoi[sp,*,1],m5_tau[*,1],name=leg_nam1[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(m5_szalo_eiionz_transp[sp,*,2]/m5_szalo_photoi[sp,*,2],m5_tau[*,2],name=leg_nam1[2],$
  thick=thck,color=colors[4],/overplot)

N2_pp4=plot(m5_szalo_eiionz_transp[sp,*,3]/m5_szalo_photoi[sp,*,3],m5_tau[*,3],name=leg_nam1[3],$
  thick=thck,color=colors[5],/overplot)

N2_pp5=plot(m5_szalo_eiionz_transp[sp,*,4]/m5_szalo_photoi[sp,*,4],m5_tau[*,4],name=leg_nam1[4],$
  thick=thck,color=colors[6],/overplot)

N2_pp6=plot(m5_szalo_eiionz_transp[sp,*,5]/m5_szalo_photoi[sp,*,5],m5_tau[*,5],name=leg_nam1[5],$
  thick=thck,color=colors[7],/overplot)
...
N2_pi1=plot(x9_szalo_photoi[sp,*,0],x9_tau[*,0],name=leg_nam1[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtleft,/current)

N2_pi2=plot(x9_szalo_photoi[sp,*,1],x9_tau[*,1],name=leg_nam1[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(x9_szalo_photoi[sp,*,2],x9_tau[*,2],name=leg_nam1[2],$
  thick=thck,color=colors[4],/overplot)

N2_pi4=plot(x9_szalo_photoi[sp,*,3],x9_tau[*,3],name=leg_nam1[3],$
  thick=thck,color=colors[5],/overplot)

N2_pi5=plot(x9_szalo_photoi[sp,*,4],x9_tau[*,4],name=leg_nam1[4],$
  thick=thck,color=colors[6],/overplot)

N2_pi6=plot(x9_szalo_photoi[sp,*,5],x9_tau[*,5],name=leg_nam1[5],$
  thick=thck,color=colors[7],/overplot)
...
N2_ei1=plot(x9_szalo_eiionz_transp[sp,*,0],x9_tau[*,0],name=leg_nam1[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
...
N2_ei2=plot(x9_szalo_eiionz_transp[sp,*,1],x9_tau[*,1],name=leg_nam1[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(x9_szalo_eiionz_transp[sp,*,2],x9_tau[*,2],name=leg_nam1[2],$
  thick=thck,color=colors[4],/overplot)

N2_ei4=plot(x9_szalo_eiionz_transp[sp,*,3],x9_tau[*,3],name=leg_nam1[3],$
  thick=thck,color=colors[5],/overplot)

N2_ei5=plot(x9_szalo_eiionz_transp[sp,*,4],x9_tau[*,4],name=leg_nam1[4],$
  thick=thck,color=colors[6],/overplot)

N2_ei6=plot(x9_szalo_eiionz_transp[sp,*,5],x9_tau[*,5],name=leg_nam1[5],$
  thick=thck,color=colors[7],/overplot)
...
N2_pp1=plot(x9_szalo_eiionz_transp[sp,*,0]/x9_szalo_photoi[sp,*,0],x9_tau[*,0],name=leg_nam1[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
...
N2_pp2=plot(x9_szalo_eiionz_transp[sp,*,1]/x9_szalo_photoi[sp,*,1],x9_tau[*,1],name=leg_nam1[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(x9_szalo_eiionz_transp[sp,*,2]/x9_szalo_photoi[sp,*,2],x9_tau[*,2],name=leg_nam1[2],$
  thick=thck,color=colors[4],/overplot)

N2_pp4=plot(x9_szalo_eiionz_transp[sp,*,3]/x9_szalo_photoi[sp,*,3],x9_tau[*,3],name=leg_nam1[3],$
  thick=thck,color=colors[5],/overplot)

N2_pp5=plot(x9_szalo_eiionz_transp[sp,*,4]/x9_szalo_photoi[sp,*,4],x9_tau[*,4],name=leg_nam1[4],$
  thick=thck,color=colors[6],/overplot)

N2_pp6=plot(x9_szalo_eiionz_transp[sp,*,5]/x9_szalo_photoi[sp,*,5],x9_tau[*,5],name=leg_nam1[5],$
  thick=thck,color=colors[7],/overplot)
...
N2_pi1=plot(m5_szalo_photoi[sp,*,6],m5_tau[*,6],name=leg_nam2[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpleft,/current)

N2_pi2=plot(m5_szalo_photoi[sp,*,7],m5_tau[*,7],name=leg_nam2[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(m5_szalo_photoi[sp,*,8],m5_tau[*,8],name=leg_nam2[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_ei1=plot(m5_szalo_eiionz_transp[sp,*,6],m5_tau[*,6],name=leg_nam2[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,xrange=xr,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpmid,/current)

N2_ei2=plot(m5_szalo_eiionz_transp[sp,*,7],m5_tau[*,7],name=leg_nam2[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(m5_szalo_eiionz_transp[sp,*,8],m5_tau[*,8],name=leg_nam2[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pp1=plot(m5_szalo_eiionz_transp[sp,*,6]/m5_szalo_photoi[sp,*,6],m5_tau[*,6],name=leg_nam2[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpright,/current)

N2_pp2=plot(m5_szalo_eiionz_transp[sp,*,7]/m5_szalo_photoi[sp,*,7],m5_tau[*,7],name=leg_nam2[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(m5_szalo_eiionz_transp[sp,*,8]/m5_szalo_photoi[sp,*,8],m5_tau[*,8],name=leg_nam2[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pi1=plot(x9_szalo_photoi[sp,*,6],x9_tau[*,6],name=leg_nam2[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtleft,/current)

N2_pi2=plot(x9_szalo_photoi[sp,*,7],x9_tau[*,7],name=leg_nam2[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(x9_szalo_photoi[sp,*,8],x9_tau[*,8],name=leg_nam2[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_ei1=plot(x9_szalo_eiionz_transp[sp,*,6],x9_tau[*,6],name=leg_nam2[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,xrange=xr,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtmid,/current)

N2_ei2=plot(x9_szalo_eiionz_transp[sp,*,7],x9_tau[*,7],name=leg_nam2[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(x9_szalo_eiionz_transp[sp,*,8],x9_tau[*,8],name=leg_nam2[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pp1=plot(x9_szalo_eiionz_transp[sp,*,6]/x9_szalo_photoi[sp,*,6],x9_tau[*,6],name=leg_nam2[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtright,/current)

N2_pp2=plot(x9_szalo_eiionz_transp[sp,*,7]/x9_szalo_photoi[sp,*,7],x9_tau[*,7],name=leg_nam2[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(x9_szalo_eiionz_transp[sp,*,8]/x9_szalo_photoi[sp,*,8],x9_tau[*,8],name=leg_nam2[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pi1=plot(m5_szalo_photoi[sp,*,9],m5_tau[*,9],name=leg_nam3[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpleft,/current)

N2_pi2=plot(m5_szalo_photoi[sp,*,10],m5_tau[*,10],name=leg_nam3[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(m5_szalo_photoi[sp,*,11],m5_tau[*,11],name=leg_nam3[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_ei1=plot(m5_szalo_eiionz_transp[sp,*,9],m5_tau[*,9],name=leg_nam3[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,xrange=xr,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpmid,/current)

N2_ei2=plot(m5_szalo_eiionz_transp[sp,*,10],m5_tau[*,10],name=leg_nam3[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(m5_szalo_eiionz_transp[sp,*,11],m5_tau[*,11],name=leg_nam3[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pp1=plot(m5_szalo_eiionz_transp[sp,*,9]/m5_szalo_photoi[sp,*,9],m5_tau[*,9],name=leg_nam3[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[0]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=postpright,/current)

N2_pp2=plot(m5_szalo_eiionz_transp[sp,*,10]/m5_szalo_photoi[sp,*,10],m5_tau[*,10],name=leg_nam3[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(m5_szalo_eiionz_transp[sp,*,11]/m5_szalo_photoi[sp,*,11],m5_tau[*,11],name=leg_nam3[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pi1=plot(x9_szalo_photoi[sp,*,9],x9_tau[*,9],name=leg_nam3[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtleft,/current)

N2_pi2=plot(x9_szalo_photoi[sp,*,10],x9_tau[*,10],name=leg_nam3[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(x9_szalo_photoi[sp,*,11],x9_tau[*,11],name=leg_nam3[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_ei1=plot(x9_szalo_eiionz_transp[sp,*,9],x9_tau[*,9],name=leg_nam3[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,xrange=xr,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtmid,/current)

N2_ei2=plot(x9_szalo_eiionz_transp[sp,*,10],x9_tau[*,10],name=leg_nam3[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(x9_szalo_eiionz_transp[sp,*,11],x9_tau[*,11],name=leg_nam3[2],$
  thick=thck,color=colors[4],/overplot)
...
N2_pp1=plot(x9_szalo_eiionz_transp[sp,*,9]/x9_szalo_photoi[sp,*,9],x9_tau[*,9],name=leg_nam3[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[sp]+titl,$
  xstyle=1,ystyle=1,xrange=xr,yrange=yr,xlog=1,$;yrange=yr,,
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posbtright,/current)

N2_pp2=plot(x9_szalo_eiionz_transp[sp,*,10]/x9_szalo_photoi[sp,*,10],x9_tau[*,10],name=leg_nam3[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(x9_szalo_eiionz_transp[sp,*,11]/x9_szalo_photoi[sp,*,11],x9_tau[*,11],name=leg_nam3[2],$
  thick=thck,color=colors[4],/overplot)
