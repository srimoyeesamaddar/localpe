...
restore,filename=floc+'peakx9_wv_szalo_2states.sav'
...
E=12397./(0.5*(nrl_wv1+nrl_wv2))   ;eV cm-2 s-1
ssflux_E=ssflux*E
...
eiionz_ht = fltarr(n_elements(zz),n_elements(nrl_wv1))  ;height integrated photoionisation energy
...
E=(12397./(0.5*(nrl_wv1+nrl_wv2)))-ph_E-500.

eiionz_E=eiionz_tot*E;eV cm-2 s-1

for i=0, 11 do $
  print,nrl_wv1[i],nrl_wv2[i],ssflux_E[i],photoi_E[i]+eiionz_E[i]
...
N2_pi1=plot(x9_szalo_photoi[2,*,0],nrl_tau[*,0],name=leg_nam[0],$
...
N2_pi2=plot(x9_szalo_photoi[2,*,1],nrl_tau[*,1],name=leg_nam[0],$
    xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
    xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
    xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
    thick=thck,color=colors[1],font_size=fnt_sz,position=posleft,/current)
...
N2_pi3=plot(x9_szalo_photoi[2,*,2],nrl_tau[*,2],name=leg_nam[0],$
    xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
    xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
    xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
    thick=thck,color=colors[1],font_size=fnt_sz,position=posleft,/current)
...
N2_pi4=plot(x9_szalo_photoi[2,*,3],nrl_tau[*,3],name=leg_nam[0],$
    xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
    xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
    xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
    thick=thck,color=colors[1],font_size=fnt_sz,position=posleft,/current)
...
N2_pi5=plot(x9_szalo_photoi[2,*,4],nrl_tau[*,4],name=leg_nam[0],$
    xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
    xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
    xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
    thick=thck,color=colors[1],font_size=fnt_sz,position=posleft,/current)
...
N2_pi6=plot(x9_szalo_photoi[2,*,5],nrl_tau[*,5],name=leg_nam[0],$
    xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
    xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
    xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
    thick=thck,color=colors[1],font_size=fnt_sz,position=posleft,/current)
...
N2_pi7=plot(SQx9_szalo_photoi[2,*,0],SQ_tau[*,0],name=leg_nam[0],$
    xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
    xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
    xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
    thick=thck,color=colors[1],font_size=fnt_sz,position=posleft,/current)
...
N2_ei8=plot(SQx9_szalo_eiionz_transp[2,*,0],zz,name=leg_nam[7],$
  thick=thck,color=colors[0],/overplot)


leg5 = LEGEND(TARGET=[N2_ei1,N2_ei2,N2_ei3,N2_ei4,N2_ei5,N2_ei6,N2_ei7,N2_ei8], POSITION=leg_loc,font_size=fnt_sz,transparency=leg_transp,/normal)
...
N2_pp8=plot(SQx9_szalo_eiionz_transp[2,*,0]/SQx9_szalo_photoi[2,*,0],zz,name=leg_nam[7],$
  thick=thck,color=colors[0],/overplot)


leg5 = LEGEND(TARGET=[N2_pp1,N2_pp2,N2_pp3,N2_pp4,N2_pp5,N2_pp6,N2_pp7,N2_pp8], POSITION=leg_loc,font_size=fnt_sz,transparency=leg_transp,/normal)
