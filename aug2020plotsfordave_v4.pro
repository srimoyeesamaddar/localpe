...
N2_pi1=plot(x9_szalo_photoi[2,*,9],zz,name=leg_nam[0],$
...
N2_pi2=plot(x9_szalo_photoi[2,*,10],zz,name=leg_nam[1],$
  thick=thck,color=colors[3],/overplot)
;
N2_pi3=plot(x9_szalo_photoi[2,*,11],zz,name=leg_nam[2],$
  thick=thck,color=colors[4],/overplot)

;
;
;N2_pi4=plot(total(x9_szalo_photoi[2,*,9:11],3),zz,name=leg_nam[3],$
;  thick=thck,color=colors[2],/overplot)
;
;N2_pi5=plot(SQx9_szalo_photoi[2,*,2],SQ_tau[*,2],name=leg_nam[4],$
...
N2_ei1=plot(x9_szalo_eiionz_transp[2,*,9],zz,name=leg_nam[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
  xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posmid,/current)

N2_ei2=plot(x9_szalo_eiionz_transp[2,*,10],zz,name=leg_nam[1],$
  thick=thck,color=colors[3],/overplot)

N2_ei3=plot(x9_szalo_eiionz_transp[2,*,11],zz,name=leg_nam[2],$
  thick=thck,color=colors[4],/overplot)

;
;
;N2_ei4=plot(total(x9_szalo_eiionz_transp[2,*,9:11],3),zz,name=leg_nam[3],$
;  thick=thck,color=colors[2],/overplot)

;N2_ei5=plot(SQx9_szalo_eiionz_transp[2,*,2],SQ_tau[*,2],name=leg_nam[4],$
;  thick=thck,color=colors[0],/overplot)
...
N2_pp1=plot(x9_szalo_eiionz_transp[2,*,9]/x9_szalo_photoi[2,*,9],zz,name=leg_nam[0],$
  xtitle=xt,ytitle=yt,title=tit_fl[1]+maj[2]+titl,$
  xstyle=1,ystyle=1,yrange=yr,xrange=xr,xlog=1,$;
  xgridstyle=xg,ygridstyle=yg,xticklen=xtl,yticklen=ytl,xsubgridstyle=xsg,ysubgridstyle=ysg,xsubticklen=xstl,ysubticklen=ystl,$
  thick=thck,color=colors[1],font_size=fnt_sz,position=posright,/current)

N2_pp2=plot(x9_szalo_eiionz_transp[2,*,10]/x9_szalo_photoi[2,*,10],zz,name=leg_nam[1],$
  thick=thck,color=colors[3],/overplot)

N2_pp3=plot(x9_szalo_eiionz_transp[2,*,11]/x9_szalo_photoi[2,*,11],zz,name=leg_nam[2],$
  thick=thck,color=colors[4],/overplot)


;
;N2_pp4=plot(total(x9_szalo_eiionz_transp[2,*,9:11],3)/total(x9_szalo_photoi[2,*,9:11],3),zz,name=leg_nam[3],$
;  thick=thck,color=colors[2],/overplot)

;N2_pp5=plot(SQx9_szalo_eiionz_transp[2,*,2]/SQx9_szalo_photoi[2,*,2],SQ_tau[*,2],name=leg_nam[4],$
;  thick=thck,color=colors[0],/overplot)
